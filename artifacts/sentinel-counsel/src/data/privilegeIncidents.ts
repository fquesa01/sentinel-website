...
export const privilegeIncidents: PrivilegeIncident[] = [
  {
    id: "fuller-hyde-school-2026",
    date: "2026-05-05",
    year: 2026,
    category: "court-filing",
    tool: "ChatGPT/Claude",
    headline:
      "D. Maine sanctions Hyde School plaintiff's counsel after Claude- or ChatGPT-drafted opposition brief introduced fabricated quotations and citations",
    quote:
      "For the first time, she disclosed that she or someone on her team had used AI — either Claude or ChatGPT — in the drafting process. She also acknowledged that she had not conducted a line-by-line citation check.",
    attribution:
      "Hon. Stacey D. Neumann, D. Me., Order Imposing Sanctions, Fuller v. Hyde School, 2:25-cv-00354-SDN",
    sourceName: "Bloomberg Law",
    sourceUrl:
      "https://news.bloomberglaw.com/litigation/lawyer-who-misused-ai-issued-non-monetary-sanctions-for-errors",
    whyItMatters:
      "Counsel admitted she did not even know which model on her team produced the fake citations — Claude or ChatGPT. When the privilege boundary is delegated to associates and contractors, partners cannot identify which consumer LLM swallowed the client's matter.",
  },
  {
    id: "berry-early-warning-2026",
    date: "2026-04-30",
    year: 2026,
    category: "court-filing",
    headline:
      "E.D. Pa. reprimands pro se FCRA plaintiff under Rule 11 for fabricated quotation and nonexistent statutory section",
    quote:
      "That quotation does not exist in the case. The opinion ends at page 916, and the pincite plaintiff used for the quote was at a nonexistent page.",
    attribution:
      "Hon. Harvey Bartle III, E.D. Pa., Memorandum, Berry v. Early Warning Services, LLC, 25-cv-4638",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2064/Berry_v._Early_Warning_USA_30_April_2026.pdf",
    whyItMatters:
      "Pro se litigants are now papering federal dockets with LLM output indistinguishable from real case law. Each fictitious quote is a privacy disclosure — every fact in the prompt rides home in OpenAI's training and retention pipeline.",
  },
  {
    id: "elbitar-hernandez-2026",
    date: "2026-04-30",
    year: 2026,
    category: "court-filing",
    headline:
      "W.D. Wash. issues OSC after habeas petitioner's counsel files brief with false quotations from Thai v. Mapes and Nadarajah",
    quote:
      "The type of citation errors contained in Petitioner's brief often occur as the result of using generative artificial intelligence without checking the citations generated by the program... Regardless of any use of generative artificial intelligence, erroneous citations suggest Petitioner's counsel submitted these filings without conducting a reasonable inquiry into the facts and the law.",
    attribution:
      "Hon. Tiffany M. Cartwright, W.D. Wash., Order to Show Cause, El Bitar v. Hernandez",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2069/Bitar_v._Hernandez_USA_30_April_2026.pdf",
    whyItMatters:
      "Federal courts now treat misquoted authority as presumptive evidence of unverified LLM use — and order counsel to swear under penalty of perjury exactly which AI tool processed the privileged habeas record.",
  },
  {
    id: "superb-motors-deo-2026",
    date: "2026-04-30",
    year: 2026,
    category: "court-filing",
    headline:
      "E.D.N.Y. fines pro se attorney $1,500 after AI-generated opposition brief cited two nonexistent cases — blame deflected to 'viruses and malware'",
    quote:
      "The use of generative artificial intelligence to assist in the drafting of legal papers that results in the creation of a legal submission containing citations to fictitious or non-existent legal authority — commonly referred to as 'hallucinated' or fake case citations.",
    attribution:
      "E.D.N.Y., Order on Sanctions, Superb Motors Inc. v. Deo (against Harry R. Thomasson, Esq.)",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2079/Superb_Motors_v._Deo_USA_30_April_2026.pdf",
    whyItMatters:
      "Even seasoned attorneys appearing pro se now reach for ChatGPT and then invent technical-sounding excuses ('viruses and malware') when caught. Sanctions stack: the privileged matter is already inside the model's logs.",
  },
  {
    id: "spiehs-smith-2026",
    date: "2026-04-29",
    year: 2026,
    category: "court-filing",
    headline:
      "D. Kan. warns First Amendment plaintiff's counsel after brief contained AI-style false quotations from Supreme Court precedent",
    quote:
      "Plaintiff's counsel submitted these filings without conducting a reasonable inquiry into the facts and the law as required by Rule 11(b).",
    attribution:
      "D. Kan., Order, Spiehs v. Smith",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2060/Spiehs_v._Smith_USA_29_April_2026.pdf",
    whyItMatters:
      "Constitutional litigation is migrating to LLMs at the same rate as personal-injury work. Civil-rights briefs invented by ChatGPT enter the public record under counsel's signature — and the prompts that birthed them sit in OpenAI retention.",
  },
  {
    id: "akins-ratliff-2026",
    date: "2026-04-28",
    year: 2026,
    category: "court-filing",
    headline:
      "M.D.N.C. magistrate warns pro se plaintiff after MSPA complaint cited nonexistent Fourth Circuit and district-court cases",
    quote:
      "Citations such as Plaintiff's to nonexistent cases are the frequent posterchild for the use of generative artificial intelligence in materials submitted to the court.",
    attribution:
      "Hon. L. Patrick Auld, M.D.N.C., Memorandum Opinion, Order, and Recommendation, Akins v. Ratliff, 1:25cv712",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2040/Akins_v._Ratliff_USA_28_April_2026.pdf",
    whyItMatters:
      "Federal magistrates now treat 'nonexistent case cite' as functionally synonymous with 'unverified ChatGPT output.' The detection no longer requires admission — and the privilege exposure already happened upstream of the brief.",
  },
  {
    id: "smith-verra-mobility-2026",
    date: "2026-04-28",
    year: 2026,
    category: "court-filing",
    tool: "ChatGPT",
    headline:
      "M.D. Fla. orders attorney to disclose ChatGPT use to client after motion to dismiss contained multiple fabricated citations",
    quote:
      "Sullivan acknowledges that he used artificial intelligence tools, including ChatGPT, to research and draft the School Board's motion to dismiss... He admits that he did not complete an independent verification of each citation before filing.",
    attribution:
      "M.D. Fla., Order, Smith v. Verra Mobility Corp. (against Jeffrey Sullivan, Esq.)",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2053/Smith_v._Verra_USA_28_April_2026.pdf",
    whyItMatters:
      "First-of-its-kind sanction: counsel must affirmatively notify the client that their privileged matter was processed through ChatGPT. The client-disclosure remedy is a tacit admission that consumer LLM use is itself a privilege event.",
  },
  {
    id: "chaney-transdev-2026",
    date: "2026-04-28",
    year: 2026,
    category: "court-filing",
    tool: "LexisNexis Protégé",
    headline:
      "C.D. Cal. sanctions plaintiff's counsel $2,500 after LexisNexis Protégé fabricated In re Shubert and two other citations in employment briefs",
    quote:
      "The Court must, once again, discuss sanctions related to the use of generative-artificial intelligence... Chaney's counsel for his misuse of generative-artificial intelligence without verification.",
    attribution:
      "C.D. Cal., Order, Chaney v. Transdev Services, Inc. (against Gavril T. Gabriel, Esq.)",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2041/Chaney_v._Transdev_Services_USA_28_April_2026.pdf",
    whyItMatters:
      "Even purpose-built legal AI from LexisNexis hallucinated. The 'enterprise legal model' marketing has now been falsified on the docket — there is no 'safe' generative substrate, only architectural controls on what data ever reaches one.",
  },
  {
    id: "gregoire-bart-2026",
    date: "2026-04-27",
    year: 2026,
    category: "court-filing",
    headline:
      "N.D. Cal. orders BART plaintiff's counsel to correct and explain AI-fabricated citation in employment brief",
    quote:
      "Order to Correct and Explain — fabricated case law generated through implied use of artificial intelligence.",
    attribution:
      "N.D. Cal., Order, Gregoire v. Board of Trustees of San Francisco Bay Area Rapid Transit District (against Jessica Barsotti, Esq.)",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2052/Gregoire_v._Board_USA_27_April_2026.pdf",
    whyItMatters:
      "Northern District of California — the same court that sanctioned Hill v. Workday counsel a day later — is now running back-to-back AI-citation OSCs. The Bay Area legal market is becoming the leading indicator for LLM-induced privilege failures.",
  },
  {
    id: "jarvis-teton-2026",
    date: "2026-04-24",
    year: 2026,
    category: "court-filing",
    headline:
      "Tenth Circuit warns pro se appellant on the record after brief misquoted and misrepresented circuit precedent in Section 1983 appeal",
    quote:
      "We warn him — and all litigants appearing before this court, whether pro se or represented by counsel — of the responsibility to ensure that quotations actually appear in the cases they purport to come from.",
    attribution:
      "U.S. Court of Appeals for the Tenth Circuit, Order and Judgment, Jarvis v. County of Teton, Wyoming",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2051/Jarvis_v._County_USA_24_April_2026.pdf",
    whyItMatters:
      "A federal circuit court issued a generally applicable warning to every litigant before it. The duty to verify every quotation against the underlying case is now treated as universal — pro se status is no longer a shield against AI-hallucination discipline.",
  },
  {
    id: "ibach-stewart-2026",
    date: "2026-04-24",
    year: 2026,
    category: "court-filing",
    headline:
      "Alabama Supreme Court dismisses appeal and imposes $17,200 in doubled costs, filing prohibition, and bar referral after attorney filed AI-hallucinated briefs",
    quote:
      "Briefs that contained invalid, inaccurate, and/or irrelevant citations to legal authorities, which authorities appeared to be the result of artificial-intelligence (AI) hallucinations.",
    attribution:
      "McCool, J., Supreme Court of Alabama, Ibach v. Stewart (against W. Perry Hall, Esq.)",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2035/Ibach__Stewart_v._Steward_USA_24_April_2026.pdf",
    whyItMatters:
      "Second state supreme court (after Georgia) to crater an entire appeal as a sanction for AI hallucinations — plus doubled costs, filing ban, and a bar referral against the attorney. State appellate courts are escalating from 'warning' to 'license event' inside the same week.",
  },
  {
    id: "dennison-caudill-2026",
    date: "2026-04-23",
    year: 2026,
    category: "court-filing",
    headline:
      "S.D. Ind. warns pro se plaintiff after Title IV-D filing cited a fictitious case generated by implied AI use",
    quote:
      "Implied use of generative artificial intelligence — fabricated case law warranting Rule 11 warning.",
    attribution:
      "S.D. Ind., Order, Dennison v. Caudill",
    sourceName: "Damien Charlotin — Hallucinations Database (PDF)",
    sourceUrl:
      "https://www.damiencharlotin.com/documents/2049/Dennisson_v._Caudill_USA_23_April_2026.pdf",
    whyItMatters:
      "Even routine domestic-relations dockets are now logging AI hallucinations. Privileged child-support and family facts are being typed into consumer LLMs by self-represented parents — the privacy exposure dwarfs the embarrassed-litigant headline.",
  },
  {
    id: "payne-georgia-2026",
    date: "2026-05-05",
    year: 2026,
    category: "court-filing",
    headline:
      "Georgia Supreme Court suspends Clayton County ADA for six months and vacates murder conviction order over AI-fabricated citations",
    quote:
      "ADA Leslie acknowledged that the case citations generated by artificial intelligence software were not independently verified before inclusion in the State's briefs or proposed order... We hereby suspend ADA Deborah Leslie's privilege to practice before the Supreme Court of Georgia for six months.",
    attribution:
      "Land, J., for the Supreme Court of Georgia, Payne v. State, No. S26A0459 (Ga. May 5, 2026)",
    sourceName: "Atlanta Journal-Constitution",
    sourceUrl:
      "https://www.ajc.com/news/2026/05/clayton-prosecutor-who-used-ai-gets-suspended-from-georgia-supreme-court/",
    whyItMatters:
      "First state supreme court to suspend a prosecutor's right to practice over AI-hallucinated citations — and to vacate the underlying conviction order because the fake cases tainted the trial court's ruling. Privilege erosion now reaches into the criminal docket: a prosecutor's prompt window can unwind a life sentence.",
  },
  {

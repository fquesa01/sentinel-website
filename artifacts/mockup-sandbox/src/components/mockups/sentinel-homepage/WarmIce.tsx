...
export function WarmIce() {
  ...
  return (
    <div className="warm-ice-container">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .warm-ice-container {
          ...
          --text-heading: #f5efe3;
          --text-body: #a89f93;
          --accent-primary: #c4a265;
          --accent-secondary: #b8934a;
          --gray-light: #9a9285;
          --gray-dark: #6b6560;
          --danger: #b54444;
          --success: #6b9b6b;
        ...
        .warm-ice-container *, .warm-ice-container *::before, .warm-ice-container *::after {
          box-sizing: border-box;
          margin: 0;
          padding: 0;
        }

        .warm-ice-container a {
          color: inherit;
          text-decoration: none;
        }

        .warm-ice-container section {
          padding: 8rem 4rem;
          max-width: 1400px;
          margin: 0 auto;
          position: relative;
        ...
        .warm-ice-container h1, .warm-ice-container h2, .warm-ice-container h3, .warm-ice-container h4 {
        ...
        .warm-ice-container h1 {
          font-size: clamp(2.5rem, 5vw, 4.25rem);
          font-weight: 200;
          letter-spacing: -0.02em;
        }

        .warm-ice-container h2 {
          font-size: clamp(2rem, 4vw, 3rem);
          margin-bottom: 1.5rem;
        }

        .warm-ice-container h3 {
          font-size: 1.25rem;
          font-weight: 300;
        }

        .warm-ice-container em {
          font-style: normal;
          color: var(--accent-primary);
        }

        .warm-ice-container .mono-label {
        ...
        .voice-prompt {
          ...
          padding-left: 2rem;
          margin-top: 2rem;
          background: linear-gradient(90deg, rgba(196, 162, 101, 0.05), transparent);
          padding-top: 1rem;
          padding-bottom: 1rem;
        }
        .voice-prompt span {
        ...
        .demo-step:first-child .step-label::after {
          content: '\u2588';
          color: var(--accent-primary);
          animation: wi-blink 1s step-end infinite;
        }
        @keyframes wi-blink {
          50% { opacity: 0; }
        }
        ...
        .result-tag.alert { 
          color: var(--danger); 
          border-color: rgba(181, 68, 68, 0.3); 
          background: rgba(181, 68, 68, 0.05);
        }
        .result-tag.success, .result-tag.voice-tag { 
          color: var(--success); 
          border-color: rgba(107, 155, 107, 0.3);
        ...
        .cap-card:hover {
          ...
          box-shadow: 0 10px 30px rgba(196, 162, 101, 0.05);
        ...
        .vault-ticks {
          ...
          animation: wi-spin 60s linear infinite;
        }
        ...
        .vault-center {
          ...
          animation: wi-vault-pulse 3s ease-in-out infinite;
        }
        @keyframes wi-vault-pulse {
          0%, 100% { box-shadow: 0 0 15px rgba(196, 162, 101, 0.1); }
          50% { box-shadow: 0 0 30px rgba(196, 162, 101, 0.4); }
        }
        ...
        .cta-section {
          ...
          border-top: 1px solid var(--border);
          background: radial-gradient(circle at center, rgba(196, 162, 101, 0.03) 0%, transparent 60%);
        }
        ...
        @media (max-width: 1024px) {
          .warm-ice-container section { padding: 6rem 2rem; }
          .wi-nav { padding: 1.5rem 2rem; }
          ...
          .wi-footer { flex-direction: column; gap: 2rem; text-align: center; }
          .hero-actions { flex-direction: column; width: 100%; max-width: 300px; }
        }
      `}} />

      <nav className={`wi-nav ${scrolled ? "scrolled" : ""}`}>
        <a href="#" className="wi-logo">
        ...
        <div className="wi-nav-links">
          ...
          <a href="#contact" className="wi-nav-cta">Request Demo</a>
        </div>
      </nav>
      ...
      <div className="trust-bar">
        <div className="trust-inner">
          <div className="trust-item">
            Voice-First — No Training Required
          </div>
          <div className="trust-item">
            Real-Time Deposition Support
          </div>
          <div className="trust-item">

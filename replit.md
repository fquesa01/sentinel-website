...
- **Pages**: HomePage (`/`), ResourcesHub (`/resources`), ContentPage (`/resources/:slug`), StartPage (`/start` — private signup, NOT linked publicly, robots noindex via useLayoutEffect)
